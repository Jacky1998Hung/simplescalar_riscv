...
extern void sim_check_ans(void);

/* execution instruction counter */
counter_t sim_num_insn = 0;
counter_t sim_num_comp_insn = 0;
counter_t sim_num_macro_fusion_set = 0;
counter_t sim_num_fused_inst = 0;
...
main(int argc, char **argv, char **envp) {
    ...
    opt_reg_flag(sim_odb, "-mf", "active macro fusion optimization",
                   &macro_fusion_active, /* default */FALSE, /* !print */FALSE, NULL);
    ...
    sim_num_insn = 0;
    sim_num_comp_insn = 0;
    sim_num_macro_fusion_set = 0;
    sim_num_fused_inst = 0;
