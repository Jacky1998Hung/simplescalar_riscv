...
#define SHT_FINI_ARRAY  0xf             /* This section contains an array of pointers to termination functions */
#define SHT_INIT_ARRAY  0xe             /* This section contains an array of pointers to initialization functions */
...
typedef qword_t elfoff_t;
typedef qword_t elf_addr_t;
typedef word_t elf_word_t;
typedef qword_t elf_xword_t;
typedef qword_t elfentry_t;
typedef half_t elf_half_t;
struct elf_filehdr
{
    unsigned char e_ident[EI_NIDENT];	/* Magic number and other info */
    elf_half_t e_type;			/* Object file type */
    elf_half_t e_machine;			/* Architecture */
    elf_word_t e_version;			/* Object file version */
    elf_addr_t e_entry;			/* Entry point virtual address */
    elfoff_t e_phoff;			/* Program header table file offset */
    elfoff_t e_shoff;			/* Sectqion header table file offset */
    elf_word_t e_flags;			/* Processor-specific flags */
    elf_half_t e_ehsize;			/* ELF header size in bytes */
    elf_half_t e_phentsize;			/* Program header table entry size */
    elf_half_t e_phnum;			/* Program header table entry count */
    elf_half_t e_shentsize;			/* Section header table entry size */
    elf_half_t e_shnum;			/* Section header table entry count */
    elf_half_t e_shstrndx;			/* Section header string table index */
};
// 64-bit
